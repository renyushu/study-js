...
(() => {
        ...
        755: function (e, t) {
            ...
            !function (t, n) {
                ...
                function Ce(e, t, n, r, i) {
                    for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((o = e[d]) || 0 === o) if ("object" === T(o)) S.merge(p, o.nodeType ? [o] : o); else if (Te.test(o)) {
                    ...
                    for (f.textContent = "", d = 0; o = p[d++];) if (r && S.inArray(o, r) > -1) i && i.push(o); else if (l = se(o), a = be(f.appendChild(o), "script"), l && we(a), n) for (c = 0; o = a[c++];) me.test(o.type || "") && n.push(o);
                    return f
                }
                ...
                S.extend({
                    htmlPrefilter: function (e) {
                        ...
                        for (var t, n, r, i = S.event.special, o = 0; void 0 !== (n = e[o]); o++) if (Q(n)) {
                            if (t = n[K.expando]) {
                ...
                var Fe = new RegExp("^(" + re + ")(?!px)[a-z%]+$", "i"), $e = /^--/, Be = function (e) {
                        ...
                        return r
                    }, ze = new RegExp(oe.join("|"), "i"), Ue = "[\\x20\\t\\r\\n\\f]",
                    Xe = new RegExp("^" + Ue + "+|((?:^|[^\\\\])(?:\\\\.)*)" + Ue + "+$", "g");

                function Ve(e, t, n) {
                    var r, i, o, a, s = $e.test(t), u = e.style;
                ...
                function it(e, t, n) {
                    var r = Be(e), i = (!v.boxSizingReliable() || n) && "border-box" === S.css(e, "boxSizing", !1, r),
                ...
                S.extend({
                    ...
                    style: function (e, t, n, r) {
                        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                            var i, o, a, s = Y(t), u = $e.test(t), l = e.style;
                ...
                function ht(e, t, n) {
                    ...
                    for (function (e, t) {
                        var n, r, i, o, a;
                        for (n in e) if (i = t[r = Y(n)], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = S.cssHooks[r]) && "expand" in a) for (n in o = a.expand(o), delete e[r], o) n in e || (e[n] = o[n], t[n] = i); else t[r] = i
                    }(c, l.opts.specialEasing); o < a; o++) if (r = ht.prefilters[o].call(l, e, c, l.opts)) return y(r.stop) && (S._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
                ...
                S.Animation = S.extend(ht, {
                    ...
                    fadeTo: function (e, t, n, r) {
                        ...
                        return "string" != typeof e && (n = t, t = e, e = void 0), t && this.queue(e || "fx", []), this.each((function () {
                            var t = !0, i = null != e && e + "queueHooks", o = S.timers, a = K.get(this);
                ...
                S.fn.extend({
                    ...
                    addClass: function (e) {
                        ...
                        return y(e) ? this.each((function (n) {
                            ...
                            if (s) for (o = S(this), i = 0; i < n.length; i++) r = n[i], o.hasClass(r) ? o.removeClass(r) : o.addClass(r); else void 0 !== e && "boolean" !== a || ((r = bt(this)) && K.set(this, "__className__", r), this.setAttribute && this.setAttribute("class", r || !1 === e ? "" : K.get(this, "__className__") || ""))
                        })))
                    }, hasClass: function (e) {
                        var t, n, r = 0;
                ...
                Bt.href = Et.href, S.extend({
                    ...
                    ajax: function (e, t) {
                        ...
                        var n, i, o, a, s, u, l, c, f, p, d = S.ajaxSetup({}, t), h = d.context || d,
    ...
    n.n = e => {
        ...
        ({
            setH1() {
                t()("body").append("<h1>你好！webpack</h1>")
            }, setH2() {
